...
export function MainMenu({ createRoomOnClick, roomListOnClick }) {
    return (
        <div style={{ display: "flex", flexDirection: "column" }}>
            <button className='btn-menu' style={{ marginBottom: "12px" }} onClick={(e) => {
    ...
    return (
        <div >
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
                ...
                <button className='btn-menu' style={{ marginTop: "12px" }} onClick={(e) => {
...
export function RoomListMenu({ btnBackToMenu, roomList, joinRoom }) {
    ...
    return (
        <div>
            ...
            <h1>Room List</h1>
            {roomList.length === 0 ?
                <h4 style={{textAlign: "center"}} >There is no room created</h4>
                :
